...
namespace UnderlyingModel
{
    ...
    {
	    public RegexMatcher(Regex reg, Func<Match, string> fullMatch, string name ) : this(reg, fullMatch, name, null)
	    {
	    }

	    public RegexMatcher(Regex reg, Func<Match, string> fullMatch, string name, Func<Match,string> simplifiedMatch)
        {
            _reg = reg;
